...
class VideosRemoteData {
    ...
    func fetchVideos(withGameId: Int) {
        ...
        let params = ["game_id": String(describing: withGameId)]
        let headers = ["Client-ID": Api.clientId]
        
        Alamofire.request(Api.Endpoint.videos.url, method: .get, parameters: params, encoding: URLEncoding.default, headers: headers)
